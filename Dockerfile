...
RUN echo "http://nl.alpinelinux.org/alpine/edge/testing" >> /etc/apk/repositories \
    ...
    && apk add --no-cache python3 flac chromaprint libmad libmad-dev python3-dev musl-dev zlib-dev gcc g++ make jpeg-dev  \
    ...
    && apk del --no-cache gcc g++ make libmad-dev python3-dev musl-dev zlib-dev jpeg-dev
